...
class Reset_password{
    ...
    public function __construct(){
        ...
        add_action('fukun_daily_tasks',[$this, 'clean_up']);
...
Greetings from Fukuoka Night,

Your go-to portal for nightlife in Fukuoka.

We received a request to reset the password for your account at Fukuoka Night. If you didn't make this request, please ignore this email. If you did, follow the instructions below to reset your password.

To reset your password:
Click on the link below or copy and paste it into your browser:
https://staging5.fukuokanight.com/reset-password?t=%s
...
If you encounter any problems or have questions, reach out to our support team at support@fukuokanight.com.

Remember, for security reasons, Fukuoka Night will never ask you for your password via email, phone, or any other communication channel.

Stay safe and enjoy your night out!

Warm regards,
The Fukuoka Night Team
", $token);


        mailing( $email,'Password Reset for Your Fukuoka Night Account', $body );
...
This is to inform you that the password for your account at Fukuoka Night has been successfully reset. If you initiated this change, you can now log in using your new password.

If you did not request a password reset or believe this action was taken in error, please contact our support team immediately at support@fukuokanight.com. It's crucial to ensure your account remains secure and only accessible by you.

Some security tips:

1. Never share your password with anyone.
2. Regularly update your password and choose a strong, unique combination of characters.
3. Always make sure you're on the official Fukuoka Night website before entering any login details.

Thank you for being a part of Fukuoka Night. Your security is our top priority.

Best regards,
The Fukuoka Night Team";

        \FukuokaNight\mailing( $email,'Your Fukuoka Night Password Has Been Reset', $body   );
